...
```{r}
slp <- dplyr::select(slp, sleep, hygiene, lifesat)
```
...
r y(x.m) = 0.0464. This is 0.12 smaller than r xy (0.5053), indicating that partial mediation is plausible. In other words, there is a portion of the relation between x and y that involves m.
